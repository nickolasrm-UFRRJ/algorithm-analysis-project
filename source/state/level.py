...
class Level(tool.State):
    ...
    def gpIsEmpty(self, group):
        if len(group.sprites()) > 0:
            return True
        return False

    def play(self, mouse_pos, mouse_click):
        previous_plants = self.plant_groups
        ...
        # health = 0
        # if self.gpIsEmpty(self.plant_groups[0]):
        #     health = self.plant_groups[0].sprites()[0].health
        ...
        # if self.gpIsEmpty(self.plant_groups[0]):
        #     if health != self.plant_groups[0].sprites()[0].health:
        #         print(self.plant_groups[0].sprites()[0].health)
        # Checking if anything changed
        if previous_plants != self.plant_groups:
            print(self.plant_groups)
            # print("Mudou")
    ...
    def addPlant(self):
        ...
        # print(self.plant_groups[map_y].sprites())
        # print(map_y)
        if self.bar_type == c.CHOOSEBAR_STATIC:
